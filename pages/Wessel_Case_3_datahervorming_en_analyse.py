...
fig= px.bar(df_2022_top100, x= 'Name', y= 'Market_Value_change', hover_data=['Market Value 2022', 'Market Value 2021'], color='Market_Value_change', height=800, width= 1000)
...
box= st.checkbox('verandering marktwaarde grootste bedrijven van 2021 (omzet)')
